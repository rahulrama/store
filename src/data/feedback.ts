...
export const SEED_FEEDBACK: CustomerFeedback[] = [
  ...
  { id: 'fb-seed-2', storeId: 's-214', capturedByUserId: 'u-col-214', capturedAt: fromNow(-70), sentiment: 'negative', department: 'Computing', skus: ['CM-LAPTOP-STUDENT'], issues: ['Price — cheaper elsewhere'], intent: 'Comparing prices', outcome: 'Still deciding', ageBand: '18–24', notes: 'Saw the Surface cheaper online, asked about a price match.', source: 'In-store' },
  { id: 'fb-seed-3', storeId: 's-214', capturedByUserId: 'u-col-214', capturedAt: fromNow(-140), sentiment: 'neutral', department: 'TV & Audio', skus: ['TV-OLED-65'], issues: ['Delivery lead time'], intent: 'Ready to buy', outcome: 'Ordered for delivery', ageBand: '45–54', notes: 'Wanted the 65" before the weekend match.', source: 'Qualtrics' },
  { id: 'fb-seed-4', storeId: 's-301', capturedByUserId: 'u-sm-301', capturedAt: fromNow(-30), sentiment: 'negative', department: 'Gaming', skus: ['GM-CONSOLE-BUNDLE'], issues: ['Out of stock here', 'Delivery lead time'], intent: 'Ready to buy', outcome: 'Went to a competitor', ageBand: '25–34', notes: 'Console bundle sold out and delivery too slow.', source: 'Trustpilot' },
  { id: 'fb-seed-5', storeId: 's-309', capturedByUserId: 'u-sm-309', capturedAt: fromNow(-45), sentiment: 'negative', department: 'Large Appliances', skus: ['LA-AIRCON'], issues: ['Out of stock here', 'Delivery lead time'], intent: 'Ready to buy', outcome: 'Left without buying', ageBand: '35–44', notes: 'Portable AC gone in the heatwave, next delivery a week out.', source: 'Google' },
  { id: 'fb-seed-6', storeId: 's-317', capturedByUserId: 'u-sm-317', capturedAt: fromNow(-60), sentiment: 'negative', department: 'Large Appliances', skus: ['LA-AIRCON'], issues: ['Delivery lead time'], intent: 'Ready to buy', outcome: 'Still deciding', ageBand: '55–64', notes: 'Delivery window too far away for the hot spell.', source: 'Qualtrics' },
  { id: 'fb-seed-7', storeId: 's-301', capturedByUserId: 'u-sm-301', capturedAt: fromNow(-90), sentiment: 'negative', department: 'Mobile & Wearables', skus: ['MB-PHONE-PRO'], issues: ['Finance & credit options', 'Delivery lead time'], intent: 'Researching', outcome: 'Still deciding', ageBand: '25–34', notes: 'Asked about Flexpay and how soon it could be delivered.', source: 'In-store' },
  ...
  { id: 'fb-seed-10', storeId: 's-126', capturedByUserId: 'u-sm-126', capturedAt: fromNow(-110), sentiment: 'negative', department: 'TV & Audio', skus: ['TV-OLED-65'], issues: ['Out of stock here'], intent: 'Ready to buy', outcome: 'Ordered for delivery', ageBand: '35–44', notes: '65" OLED not on the floor, ordered for home delivery.', source: 'Qualtrics' },
  { id: 'fb-seed-11', storeId: 's-228', capturedByUserId: 'u-sm-228', capturedAt: fromNow(-100), sentiment: 'negative', department: 'Customer Service', skus: [], issues: ['Waiting / staff availability'], intent: 'Support / returns', outcome: 'Support only', ageBand: '65+', notes: 'Long wait at the service desk on a busy Saturday.', source: 'Google' },
  ...
  { id: 'fb-seed-14', storeId: 's-309', capturedByUserId: 'u-sm-309', capturedAt: fromNow(-120), sentiment: 'negative', department: 'Large Appliances', skus: ['LA-FAN-TOWER'], issues: ['Delivery lead time'], intent: 'Ready to buy', outcome: 'Still deciding', ageBand: '45–54', notes: 'Fans low on the floor, asked when more arrive.', source: 'In-store' },
  ...
  { id: 'fb-seed-16', storeId: 's-309', capturedByUserId: 'u-sm-309', capturedAt: fromNow(-150), sentiment: 'negative', department: 'Large Appliances', skus: ['LA-AIRCON'], issues: ['Delivery lead time'], intent: 'Ready to buy', outcome: 'Left without buying', ageBand: '45–54', notes: 'Another AC enquiry — same delivery problem in the heatwave.', source: 'Google' },
]
