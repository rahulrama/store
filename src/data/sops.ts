...
export const SOPS: Sop[] = [
  ...
  {
    id: 'sop-electrical-check',
    title: 'Electrical safety check (powered demo stock)',
    domainId: 'safety-compliance',
    summary: 'Daily electrical safety walk — powered demo units checked for damaged leads, plugs and overheating.',
    keywords: ['electrical', 'pat', 'pat test', 'demo stock', 'compliance check', 'safety check'],
    steps: [
      'Walk the powered demo units — check leads, plugs and sockets for damage or wear.',
      'Confirm nothing is overheating and that vents are clear.',
      'Remove and quarantine any unit that fails, then raise an equipment fault.',
