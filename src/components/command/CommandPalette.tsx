...
export function CommandPalette() {
  ...
  const commands = useMemo<Command[]>(() => {
    const list: Command[] = [
      ...
      { id: 'go-repairs', group: 'Go to', label: 'Repair Desk', icon: Wrench, keywords: 'repair replace write-off warranty mobile insurance care & repair fix service', run: () => { setPersona('Store'); navigate('/store/repairs') } },
